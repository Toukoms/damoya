        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 overflow-hidden bg-white rounded-2xl shadow-xl">
          ...
          <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
            ...
            <p className="font-sans text-text-body text-lg mb-10 leading-relaxed">
              Parlez-nous de votre projet et recevez une proposition culinaire personnalisée. Que ce soit pour un mariage, une Bar Mitzvah ou un événement professionnel, nous sommes là pour vous accompagner.
            </p>
            ...
            <div className="space-y-8 mb-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold text-text-dark mb-1">Téléphone</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold text-text-dark mb-1">Email</h3>
                  <a href="mailto:info@damoyatraiteur.fr" className="font-sans text-text-body hover:text-primary transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold text-text-dark mb-1">Adresse</h3>
                  <p className="font-sans text-text-body">123 Rue de la Gastronomie, 75000 Paris</p>
                </div>
              </div>
            </div>
