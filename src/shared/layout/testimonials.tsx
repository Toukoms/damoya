...
export function Testimonials() {
  const testimonials = [
    {
      id: 1,
      quote: "Damoya Traiteur a transformé notre mariage en une expérience gastronomique exceptionnelle. Chaque plat était raffiné, élégant et parfaitement exécuté.",
      author: "Sarah & David Lévy",
      role: "Mariage, Paris"
    },
    {
      id: 2,
      quote: "Une qualité remarquable, un service irréprochable et une tranquillité totale. Nos invités ont été impressionnés du début à la fin.",
  ...
  return (
    <section className="bg-light-neutral section-padding">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white p-8 md:p-10 rounded-lg shadow-sm relative">
