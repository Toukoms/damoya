...
export function ExploreMore() {
  return (
    <section id="explore" className="bg-background section-padding">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {PRESTATIONS.map((category) => (
            ...
            >
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-linear-to-t from-foreground/70 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300" />

              <div className="absolute bottom-0 left-0 right-0 p-6 text-primary-foreground transform translate-y-0 transition-transform duration-300">
        ...
        <div className="flex justify-center">
          <Link
            href="/dishes"
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded font-sans font-semibold transition-colors duration-300"
          >
